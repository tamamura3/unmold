...
<jsp:include page="/actionTagHeader.jsp" />
	...
	<div class="body-wrapper">
		...
		<div class="signup-header-w">
			...
			<div class="signup-img-w"><img src="/GetOut/image/speech.png"><br>Write a review on challenges.</div>
			<div class="signup-img-w"><img src="/GetOut/image/resume.png"><br>Record challneges you've done.</div>
		</div>
