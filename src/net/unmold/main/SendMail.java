...
public class SendMail {
	...
	public void SendMailExecute(String mail, String token) {
		...
		try {
			...
			message.setText("Visit this link to verify your e-mail address."+crlf+"http://localhost:8080/unmold/MailVerified?verify="+token+crlf+crlf+
	...
	public void sendMailForResetPass(String mail, String token) {
		...
		try {
			...
			message.setText("http://localhost:8080/unmold/VerifyResetPass?verify="+token);
			Transport.send(message);
