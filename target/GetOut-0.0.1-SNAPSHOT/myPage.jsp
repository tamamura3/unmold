...
<body>
	...
	<%@ page import="net.getout.beans.Achievement"%>
	<%@ page import="java.util.List"%>
	<%@ page import="net.getout.dao.GetChallengeDAO"%>
	...
	<div class="body-wrapper">
		...
		<div>
			...
			<div class="mypage-single-challenge-w">
				...
				<div class="mypage-challenge-nav-w">
					...
					<%@ page import="net.getout.dao.GetReviewDAO"%>
					<%
					...
					<%
						if (reviewed) {
					%>
					<a href="/GetOut/MyReview?number=<%=challenge.getChallengeId()%>"><div
							class="mypage-challenge-menu">MyReview</div></a>
					<%
						}else{
					%>
					<a
						href="/GetOut/review-form?id=<%=challenge.getChallengeId()%>&title=<%=StringEscapeUtils.escapeHtml(challenge.getChallengeName())%>"><div
		...
		<div class="account-setting-w">
			...
			<a href="/GetOut/user-info"><div class="mypage-setting-menu">EDIT
					INFO</div></a> <a href="/GetOut/LogoutLogic" onclick="return confirmLogout()"><div
					class="mypage-setting-menu">LOG OUT</div> <a
				href="/GetOut/delete-account"><div class="mypage-setting-menu">DELETE
						ACCOUNT</div></a>
		</div>
	</div>
