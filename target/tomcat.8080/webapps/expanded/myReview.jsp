...
<body>
	...
	<div class="body-wrapper">
		<%@ page import="net.unmold.beans.User"
			import="net.unmold.beans.Challenge" import="net.unmold.beans.Reviews"%><!-- import="javax.servlet.http.HttpSession" -->
		<%
		...
		<div class="myreview-w">
			...
			<a href="/unmold/DeleteReview?challenge=<%=challenge.getChallengeId()%>" onclick="return confirmDeleteReview()"><div class="review-delete-btn">delete</div></a>
		</div>
